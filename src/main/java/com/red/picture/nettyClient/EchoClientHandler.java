 ...
 * under the License.
 */
package com.red.picture.nettyClient;
 
import java.io.UnsupportedEncodingException;
import java.nio.charset.Charset;


import com.red.picture.encoder.Header;
import com.red.picture.encoder.Message;
 ...
 * the server.
 * 回显客户端的处理程序实现。它通过向服务器发送第一条消息来启动echo客户端和服务器之间的乒乓通信
 */
